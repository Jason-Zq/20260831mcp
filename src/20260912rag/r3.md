...
## 2.1. Characterisation offlow regime
...
![](images/41b1caf4f9be0bdff88a7ecc2cb5af1f0c5e32b69683660246460eccac4f1326.jpg)  
...
$$
N _ {\text { zero }} = a + b (\Delta P) + \frac {Y}{1 + \exp \left(\frac {T - T _ {\text { half }}}{S}\right)}\tag{3}
$$
...
$$
E = 1. 0 - \frac {\sum_ {i = 1} ^ {N} (O _ {i} - P _ {i}) ^ {2}}{\sum_ {i - 1} ^ {N} (O _ {i} - \bar {O}) ^ {2}}\tag{4}
$$
...
$$
F = \frac {\left[ \left(\mathrm{SSE} _ {\mathrm{s}} - \mathrm{SSE} _ {\mathrm{c}}\right) / \left(\mathrm{df} _ {\mathrm{c}} - \mathrm{df} _ {\mathrm{s}}\right) \right]}{\mathrm{SSE} _ {\mathrm{c}} / \mathrm{df} _ {\mathrm{c}}}\tag{7}
$$
...
![](images/d51cddc72ee1334a79fd38f66966ed0fe4189dfaeba92843a1096ab50207961f.jpg)  
...
![](images/5756a6c0f4fdef0db0ad231cf299a18103ce179332f9fc3eead1fd486098935c.jpg)  
...
![](images/d8da5647f259533a028d0924ac5c7733b6c3c5cbd394dcb0fd5eb57c8aac3ed9.jpg)
